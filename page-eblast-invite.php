 ...
 */
  ...
  function es_replace($replace, $section){
    if($section == "copy"){
      ...
      $copy_fixes = array(
        "<p style=\"margin-top: 0;color: #000;font-family: sans-serif;font-size: 21px;line-height: 29px;margin-bottom: 32px;text-align: right\">",
        ...
        "<p style=\"margin-top: 0;color: #000;font-family: sans-serif;font-size: 21px;line-height: 29px;margin-bottom: 32px;text-align: left\">",
        "<p style=\"margin-top: 0;color: #000;font-family: sans-serif;font-size: 21px;line-height: 29px;margin-bottom: 32px;text-align: left\">",
        "&rsquo;",
        "&rsquo;",
        "&ldquo;",
    ...
    "&hearts;"
      ...
      $copy_fixes = array(
        "<p style=\"margin-top: 0;color: #000;font-family: sans-serif;font-size: 16px;line-height: 24px;margin-bottom: 24px;text-align: right\">",
        ...
        "<p style=\"margin-top: 0;color: #000;font-family: sans-serif;font-size: 16px;line-height: 24px;margin-bottom: 24px;text-align: left\">",
        "<p style=\"margin-top: 0;color: #000;font-family: sans-serif;font-size: 16px;line-height: 24px;margin-bottom: 24px;text-align: left\">",
        "&rsquo;",
        "&rsquo;",
        "&ldquo;",
    ...
    "&hearts;"
      ...
      $copy_fixes = array(
        "<p style=\"margin-top: 0;color: #000;font-family: sans-serif;font-size: 14px;line-height: 22px;margin-bottom: 23px;text-align: right\">",
        ...
        "<p style=\"margin-top: 0;color: #000;font-family: sans-serif;font-size: 14px;line-height: 22px;margin-bottom: 23px;text-align: left\">",
        "<p style=\"margin-top: 0;color: #000;font-family: sans-serif;font-size: 14px;line-height: 22px;margin-bottom: 23px;text-align: left\">",
        "&rsquo;",
        "&rsquo;",
        "&ldquo;",
...
<!-- HEADLINE -->
                              <h1 style="margin-top: 0;color: #000;font-weight: normal;font-size: 52px;margin-bottom: 22px;font-family: Georgia,serif;text-align: center;line-height: 60px">
                                <?php echo es_replace(get_field('event_title'), 'headline'); ?>
                              </h1>
<!-- END HEADLINE -->
                            </td>
                          </tr>
...
<!-- LOCATION -->
                            <td class="padded" style="padding: 0;vertical-align: top;padding-left: 32px;padding-right: 32px;word-break: break-word;word-wrap: break-word">
                              ...
                              <?php echo es_replace(get_field('event_location'), 'location'); ?>
                            </td>
<!-- END LOCATION -->
                          </tr>
                        </tbody>
                    ...
                    <td class="column second" style="padding: 0;vertical-align: top;text-align: left;width: 300px">
                      ...
                      <table class="contents" style="border-collapse: collapse;border-spacing: 0;table-layout: fixed;width: 100%">
                        <tbody>
                          <tr>
<!-- DATE AND TIME -->
                            <td class="padded" style="padding: 0;vertical-align: top;padding-left: 32px;padding-right: 32px;word-break: break-word;word-wrap: break-word; border-left:3px solid #808080;">
                              <h3 style="margin-top: 0;color: #000;font-weight: normal;font-size: 16px;line-height: 22px;margin-bottom: 14px;font-family: Georgia,serif;text-align: center">
                                <strong style="font-weight: bold">Date &amp; Time</strong>
                              </h3>
                              <?php echo es_replace(get_field('event_date_and_time'), 'date'); ?>
                            </td>
<!-- END DATE AND TIME -->
                          </tr>
                        </tbody>
