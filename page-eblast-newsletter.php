<?php
/**
 * Template Name: eBlast: Newsletter
 */
  ...
  function es_replace($replace, $section){
    if($section == "copy"){
      ...
      $copy_fixes = array(
        "<p style=\"margin-top: 0;color: #000;font-family: sans-serif;font-size: 14px;line-height: 22px;margin-bottom: 22px; text-align: right;\">",
        "<p style=\"margin-top: 0;color: #000;font-family: sans-serif;font-size: 14px;line-height: 22px;margin-bottom: 22px; text-align: center;\">",
        "<p style=\"margin-top: 0;color: #000;font-family: sans-serif;font-size: 14px;line-height: 22px;margin-bottom: 22px; text-align: left;\">",
        "<p style=\"margin-top: 0;color: #000;font-family: sans-serif;font-size: 14px;line-height: 22px;margin-bottom: 22px; text-align: left;\">",
        "&rsquo;",
        "&rsquo;",
        "&ldquo;",
                  ...
                  <tr>
                    <td class="column" style="padding: 0;vertical-align: top;text-align: left">
                      <div class="image" style="margin-bottom: 24px; color: #000; font-family: helvetica, arial, sans-serif; font-size: 12px; mso-line-height-rule: at-least; text-align: center">
                        <img alt="<?php the_field('image_alt_text'); ?>" height="400" src="<?php the_field('banner_image'); ?>" style="border: 0;-ms-interpolation-mode: bicubic;display: block;max-width: 600px" width="600" />
                      </div>
...
<!-- INTRO HEADLINE and PARAGRAPH -->
                              ...
                              ?>
<!-- END INTRO HEADLINE and PARAGRAPH -->
                            </td>
                          </tr>
                        </tbody>
                      </table>
      ...
      <!-- END HEADLINE COPY -->
                            ...
                            <div class="image" style="margin-bottom: 24px; color: #000; font-family: sans-serif; font-size: 12px; mso-line-height-rule: at-least; text-align: center">
                              <img alt="" height="13" src="http://www.csun.edu/ua/email/20150829_csun-templates_v1/images/bg_border2.png" style="border: 0;-ms-interpolation-mode: bicubic;display: block;max-width: 600px" width="600" />
                            </div>
                            <div class="column-bottom" style="font-size: 8px;line-height: 8px">
                              &nbsp;
                            </div>
                          ...
                          <td class="column first" style="padding: 0;vertical-align: top;text-align: left;width: 300px">
                            ...
                            <table class="contents" style="border-collapse: collapse;border-spacing: 0;table-layout: fixed;width: 100%">
                              <tbody>
                                <tr>
                                  <td class="padded" style="padding: 0;vertical-align: top;padding-left: 32px;padding-right: 32px;word-break: break-word;word-wrap: break-word">
                                    <table align="center" class="image" style="border-collapse: collapse;border-spacing: 0;font-size: 0;margin-bottom: 23px;mso-line-height-rule: at-least;color: #000;font-family: sans-serif">
                                      <tbody>
                                        <tr>
                                          <td class="image-frame" style="padding: 6px;vertical-align: top;background-color: #D8D2C4">
                                            <span class="image-background" style="display: inline-block;font-size: 12px;background-color: #f6f5e6">
      <!-- CONTENT IMAGE -->
                                              <img alt="<?php the_sub_field('content_image_alt_text'); ?>" height="220" src="<?php the_sub_field('content_image'); ?>" style="border: 0;-ms-interpolation-mode: bicubic;display: block;max-width: 300px" width="220" />
      <!-- END CONTENT IMAGE -->
                                            </span>
                                          </td>
                                        </tr>
                                        <tr>
                                          <td class="border" style="padding: 0;vertical-align: top;font-size: 1px;line-height: 1px;background-color: #ddd8a1;width: 1px">
                                            &nbsp;
                                          </td>
                                        </tr>
                                      </tbody>
      ...
      <!-- CONTENT CONTENT -->
                                    <h2 style="margin-top: 0;color: #000;font-style: italic;font-weight: normal;font-size: 20px;line-height: 26px;margin-bottom: 18px;font-family: Georgia,serif">
                                      <?php if(get_sub_field('content_link')): ?>
                                        <a href="<?php the_sub_field('content_link'); ?>" style="color: #d00d2d; text-decoration: none;">
                                          <strong style="font-weight: bold"><?php the_sub_field('content_headline'); ?></strong>
                                        </a>
                                      <?php else: ?>
                                        <strong style="font-weight: bold"><?php the_sub_field('content_headline'); ?></strong>
                                      <?php endif; ?>
                                    ...
                                    <?php
                                      echo es_replace(the_sub_field('content_copy'), 'content');
                                    ?>
                                    <p style="margin-top: 0;color: #000;font-family: sans-serif;font-size: 14px;line-height: 22px;margin-bottom: 23px">
                                      <?php if(get_sub_field('content_link')): ?>
                                        <a href="<?php the_sub_field('content_link'); ?>" style="transition: opacity 0.2s ease-in;text-decoration: underline;color: #d00d2d"><strong style="font-weight: bold">Read More</strong></a>
                                      <?php endif; ?>
                                    </p>
      <!-- END CONTENT CONTENT -->
                                  </td>
...
<!-- SECTION HEADLINE -->
                              <h1 style="margin-top: 0;color: #000;font-weight: 700;font-size: 36px;margin-bottom: 18px;font-family: Georgia,serif;line-height: 44px">
                                <?php echo es_replace(get_field('closing_title'), 'closing_title'); ?>
                              </h1>
...
<!-- SECTION COPY -->
                              <?php
                                echo es_replace(get_field('closing_copy'), 'copy');
                              ?>
<!-- END SECTION COPY -->
                            </td>
                          </tr>
  ...
  <!-- CONTACT COLUMN <-->  
                                ...
                                <?php
                                  echo es_replace(the_field('contact_us'), 'content');
                                ?>
  <!-- END CONTACT COLUMN -->
                              </td>
                            </tr>
                    ...
                    <?php if(the_sub_field('link_title')): ?>
                      <td class="column second" style="padding: 0;vertical-align: top;text-align: left;width: 300px">
                        <div>
                          <div class="column-top" style="font-size: 32px;line-height: 32px">
                            &nbsp;
  ...
  <!-- LINKS CONTACT COLUMN -->
                                ...
                                <p style="margin-top: 0;color: #000;font-family: sans-serif;font-size: 14px;line-height: 22px;margin-bottom: 23px">
                                  <?php
                                    // check if the repeater field has rows of data
                                    if( have_rows('department_links') ):
                                      // loop through the rows of data
                                      while ( have_rows('department_links') ) : the_row(); ?>
                                        <a href="<?php the_sub_field('link_url'); ?>" target="_blank" style="transition: opacity 0.2s ease-in;text-decoration: underline;color: #d00d2d"><?php the_sub_field('link_title'); ?></a><br/>
                                    <?php endwhile; ?>
                                  <?php endif; ?>
                                </p>
