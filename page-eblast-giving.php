                        ...
                        <tbody>
                          <tr>
                            <td class="padded" style="padding: 0;vertical-align: top;padding-left: 32px;padding-right: 32px;word-break: break-word;word-wrap: break-word">
                              <!-- CONTENT -->
                              <p style="margin-top: 0;color: #000;font-family: helvetica, arial, sans-serif;font-size: 16px;line-height: 24px;margin-bottom: 24px">
                                Dear Campus Community,
                              </p>
                              <p style="margin-top: 0;color: #000;font-family: helvetica, arial, sans-serif;font-size: 16px;line-height: 24px;margin-bottom: 24px">
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus finibus dolor in mollis facilisis. Donec ex magna, pellentesque in nisi imperdiet, consequat tristique nisi. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Praesent non dolor vel tellus sollicitudin dignissim at et metus. Quisque varius ex enim, vitae dictum purus scelerisque sed.
                              </p>
                              <p style="margin-top: 0;color: #000;font-family: helvetica, arial, sans-serif;font-size: 16px;line-height: 24px;margin-bottom: 24px">
                                Suspendisse massa nunc, sagittis a sagittis sed, fermentum non velit. Vivamus id lacinia purus. Phasellus et ex eu sem pellentesque commodo vitae eu velit. Morbi ac mollis quam, non euismod ex. Fusce eleifend mauris venenatis, bibendum elit sit amet, vulputate purus. Ut urna turpis, aliquam eget porta ut, posuere at augue. Nunc accumsan metus sed nunc pellentesque, eget consequat sem rutrum. Quisque molestie justo eget diam laoreet, non euismod odio imperdiet.
                              </p>
                              <p style="margin-top: 0;color: #000;font-family: helvetica, arial, sans-serif;font-size: 16px;line-height: 24px;margin-bottom: 24px">
                                Nam lectus urna, sollicitudin sed metus nec, efficitur lacinia massa. Cras vehicula porttitor pellentesque. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Mauris id interdum nulla, eget fringilla ex. Cras eu nisl et nibh suscipit aliquam vitae non diam.
                              </p>
                              <p style="margin-top: 0;color: #000;font-family: helvetica, arial, sans-serif;font-size: 16px;line-height: 24px;margin-bottom: 24px">
                                Aliquam maximus, diam a convallis venenatis, nisi nisi viverra erat, eu posuere massa tellus at nunc. Integer feugiat velit at ex sollicitudin pretium. Quisque porta leo non risus placerat, bibendum varius ex porta. Pellentesque ligula velit, tempor vel accumsan eu, sagittis ut nibh.
                              </p>
                              <p style="margin-top: 0;color: #000;font-family: helvetica, arial, sans-serif;font-size: 16px;line-height: 24px;margin-bottom: 24px">
                                Sincerely,
                              </p>
                              <p style="margin-top: 0;color: #000;font-family: helvetica, arial, sans-serif;font-size: 16px;line-height: 24px;margin-bottom: 24px">
                                Pete Medina<br/>
                                Web Producer, Marketing &amp; Communications
                              </p><!-- END CONTENT -->
                            </td>
                          </tr>
                        </tbody>
      ...
      <table class="centered" style="border-collapse: collapse;border-spacing: 0;margin-left: auto;margin-right: auto">
        <tbody>
          <tr>
            ...
            <td style="padding: 0;vertical-align: top">
              <table class="one-col-feature" style="border-collapse: collapse;border-spacing: 0;background-color: #d8d2c4;font-size: 14px;table-layout: fixed;margin-left: auto;margin-right: auto;width: 600px">
                <tbody>
                  <tr>
                    <td class="column" style="padding: 0;vertical-align: top;text-align: center;width: 600px">
                          ...
                          <tr>
                            <td class="padded" style="padding: 0;vertical-align: top;padding-left: 32px;padding-right: 32px;word-break: break-word;word-wrap: break-word">
                              <h1 style="margin-top: 0;color: #000;font-weight: normal;font-size: 52px;margin-bottom: 22px;font-family: Georgia,serif;text-align: center;line-height: 60px">
                                <strong style="font-weight: bold">SUPPORT CSUN</strong>
                              </h1>
                            </td>
                          </tr>
                        </tbody>
                      ...
                      <table class="contents" style="border-collapse: collapse;border-spacing: 0;table-layout: fixed;width: 100%">
                        <tbody>
                          <tr>
                            <td class="padded" style="padding: 0;vertical-align: top;padding-left: 32px;padding-right: 32px;word-break: break-word;word-wrap: break-word">
                              <p style="margin-top: 0;color: #000;font-family: helvetica, arial, sans-serif;font-size: 21px;line-height: 29px;margin-bottom: 32px;text-align: center">
                      ...
                      <table class="contents" style="border-collapse: collapse;border-spacing: 0;table-layout: fixed;width: 100%">
                        <tbody>
                          <tr>
                            <td class="padded" style="padding: 0;vertical-align: top;padding-left: 32px;padding-right: 32px;word-break: break-word;word-wrap: break-word">
                              <div class="btn" style="margin-bottom: 32px;text-align: center">
                                <![if !mso]><a href="http://give.csun.edu" target="_blank" style="border-radius: 3px;display: inline-block;font-size: 14px;font-weight: 700;line-height: 24px;padding: 13px 35px 12px 35px;text-align: center;text-decoration: none !important;transition: opacity 0.2s ease-in;color: #fff;font-family: helvetica, arial, sans-serif;background-color: #d00d2d">Support CSUN</a><![endif]> <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" href="http://give.csun.edu" target="_blank" style="width:169px" arcsize="7%" fillcolor="#D00D2D" stroke="f"><v:textbox style="mso-fit-shape-to-text:t" inset="0px,12px,0px,11px"><center style="font-size:14px;line-height:24px;color:#FFFFFF;font-family:sans-serif;font-weight:700;mso-line-height-rule:exactly;mso-text-raise:4px">RSVP Today</center></v:textbox></v:roundrect><![endif]-->
                              </div>
                            </td>
                          </tr>
                        </tbody>
