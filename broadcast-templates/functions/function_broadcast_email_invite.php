...
function broadcast_email_invite($department, $preheader, $banner, $title, $copy, $copy_secondary, $rsvp, $location, $date, $time) {

  // Replace paragraphs, smart quotes, and links
  $copy_paragraphs = array("<p style=\"text-align: center;\">", "<p>", "’", "'", "“", "”", ":00");
  $copy_fixes = array("<p style=\"margin-top: 0;color: #000;font-family: sans-serif;font-size: 18px;line-height: 29px;margin-bottom: 32px;text-align: center\">", "<p style=\"margin-top: 0;color: #000;font-family: sans-serif;font-size: 18px;line-height: 29px;margin-bottom: 32px;text-align: left\">", "&rsquo;", "&rsquo;", "&ldquo;", "&rdquo;", "");

  $copy_fixed = str_replace($copy_paragraphs, $copy_fixes, $copy);
  ...
  $date_fixed = str_replace($date_ap_find, $date_ap_replace, $date);
  $time_fixed = str_replace($date_ap_find, $date_ap_replace, $time);
  ...
  $location_fixed = str_replace($location_find, $location_replace, $location);
...
<!-- VIEW ONLINE -->
                      <a href="http://www.csun.edu/ua/email/20170406_Entertainment_Panel/" target="_blank" style="color: #D00D2D;">Read This Email Online</a>
<!-- END VIEW ONLINE -->
                    </td>
                  </tr>
                </tbody>
          ...
          <tr>
            <td class="logo" style="padding: 0;vertical-align: top;mso-line-height-rule: at-least;padding-top: 32px;padding-bottom: 42px">
              <div class="logo-center" id="emb-email-header" style="color: #41637e; font-family: helvetica, arial, sans-serif; font-size: 26px; font-weight: 700; letter-spacing: -0.02em; line-height: 32px; text-align: center">
                <img alt="California State University, Northridge"  src="http://www.csun.edu/ua/email/20150423_logos/csun-logo_2015_alumni.png" style="border: 0;-ms-interpolation-mode: bicubic;display: block;margin-left: auto;margin-right: auto;max-width: 397px" width="397" />
              </div>
            </td>
          </tr>
        </tbody>
                  ...
                  <tr>
                    <td class="column" style="padding: 0;vertical-align: top;text-align: left">
                      <div class="image" style="margin-bottom: 24px; color: #000; font-family: helvetica, arial, sans-serif; font-size: 12px; mso-line-height-rule: at-least; text-align: center">
                        <img alt=""  src="'.$banner.'" style="border: 0;-ms-interpolation-mode: bicubic;display: block;max-width: 600px" width="600" />
                      </div>
                      ...
                      <table class="contents" style="border-collapse: collapse;border-spacing: 0;table-layout: fixed;width: 100%">
                        <tbody>
                          <tr>
                            <td class="padded" style="padding: 0;vertical-align: top;padding-left: 32px;padding-right: 32px;word-break: break-word;word-wrap: break-word">
<!-- COPY -->
<p style="color: #000; font-family: sans-serif; font-size: 22px; line-height: 29px; margin-bottom: 32px; text-align: center;"><strong>'.$title.'</strong></p>
                              '.$copy_fixed.'
      ...
      <table class="centered" style="border-collapse: collapse;border-spacing: 0;margin-left: auto;margin-right: auto">
        <tbody>
          <tr>
            ...
            <td style="padding: 0;vertical-align: top">
              <table class="two-col" style="border-collapse: collapse;border-spacing: 0;margin-left: auto;margin-right: auto;width: 600px;background-color: #11111;font-size: 14px;table-layout: fixed">
                <tbody>
                  <tr>
...
<!-- LOCATION -->
                            <td class="padded" style="padding: 0;vertical-align: top;padding-left: 32px;padding-right: 32px;word-break: break-word;word-wrap: break-word">
                              <h3 style="margin-top: 0;color: #000;font-weight: bold;font-size: 16px;line-height: 22px;margin-bottom: 14px;font-family: Georgia,serif;text-align: center">
                                '.$location_fixed.'
                              </h3>
                            </td>
<!-- END LOCATION -->
                    ...
                    <td class="column second" style="padding: 0;vertical-align: top;text-align: left;width: 300px;border-left:3px solid #000;">
                      <div>
...
<!-- DATE AND TIME -->
                            <td class="padded" style="padding: 0;vertical-align: top;padding-left: 32px;padding-right: 32px;word-break: break-word;word-wrap: break-word;">
                              <h3 style="margin-top: 10%;color: #000;font-weight: bold;font-size: 16px;line-height: 18px;margin-bottom: 14px;font-family: Georgia,serif;text-align: center">
                                '.$date_fixed.'<br>
                                '.$time_fixed.'
                              </h3>
...
<!-- BUTTON -->
                              <div class="btn" style="margin-bottom: 24px;text-align: center">
                                ...
                                style="border-radius: 3px;display: inline-block;font-size: 14px;font-weight: 700;line-height: 24px;padding: 13px 35px 12px 35px;text-align: center;text-decoration: none !important;transition: opacity 0.2s ease-in;color: #fff;font-family: sans-serif;background-color: #d22030">RSVP</a>
                              </div>
<!-- END BUTTON -->
                            </td>
                          </tr>
                      ...
                      <table class="contents" style="margin-top: 0;color: #000;font-family: sans-serif;font-size: 18px;line-height: 24px;margin-bottom: 24px;text-align: center;">
                        <tbody>
                          <tr>
                            <td class="padded" style="padding: 0;vertical-align: top;padding-left: 32px;padding-right: 32px;word-break: break-word;word-wrap: break-word">
<!-- PHONE or OTHER CONTACT --><h3 style="margin-top: 0;color: #000;font-family: sans-serif;font-size: 18px;line-height: 24px;margin-bottom: 24px;text-align: center;">'.$copy_secondary.'</h3>
                    ...
                    <td class="social-link" style="padding: 0;vertical-align: top">
                      <table style="border-collapse: collapse;border-spacing: 0">
                        <tbody>
                          <tr>
                            <td style="padding: 0;vertical-align: top">
                              <a href="http://www.csun.edu/alumni" target="_blank"><img height="26" src="http://www.csun.edu/ua/email/20150831_email-assets_v1/social-images/dub-dub-dub.png" alt="Website icon" style="border: 0;-ms-interpolation-mode: bicubic;display: block" width="26" /></a>
                            </td>
                            <td class="social-text" style="padding: 0;vertical-align: middle !important;height: 21px;font-size: 10px;font-weight: bold;text-decoration: none;text-transform: uppercase;color: #000;letter-spacing: 0.05em;font-family: helvetica, arial, sans-serif">
                              <a href="http://www.csun.edu/alumni" style="color: #D00D2D" target="_blank">&nbsp;&nbsp;CSUN.EDU</a>
                            </td>
                          </tr>
                        </tbody>
                      </table>
                    ...
                    <td class="social-link" style="padding: 0;vertical-align: top">
                      <table style="border-collapse: collapse;border-spacing: 0">
                        <tbody>
                          <tr>
                            <td style="padding: 0;vertical-align: top">
                              <a href="https://www.facebook.com/csunalumni/" target="_blank"><img height="26" src="http://www.csun.edu/ua/email/20150831_email-assets_v1/social-images/facebook.png" alt="Facebook icon" style="border: 0;-ms-interpolation-mode: bicubic;display: block" width="26" /></a>
                            </td>
                            <td class="social-text" style="padding: 0;vertical-align: middle !important;height: 21px;font-size: 10px;font-weight: bold;text-decoration: none;text-transform: uppercase;color: #000;letter-spacing: 0.05em;font-family: helvetica, arial, sans-serif">
                              <a href="https://www.facebook.com/csunalumni/" style="color: #D00D2D" target="_blank">Facebook </a>
                            </td>
                          </tr>
                        </tbody>
                      </table>
                    ...
                    <td class="social-link" style="padding: 0;vertical-align: top">
                      <table style="border-collapse: collapse;border-spacing: 0">
                        <tbody>
                          <tr>
                            <td style="padding: 0;vertical-align: top">
                              <a href="https://twitter.com/CSUN_Alumni" target="_blank"><img height="26" src="http://www.csun.edu/ua/email/20150831_email-assets_v1/social-images/twitter.png" alt="Twitter icon" style="border: 0;-ms-interpolation-mode: bicubic;display: block" width="26" /></a>
                            </td>
                            <td class="social-text" style="padding: 0;vertical-align: middle !important;height: 21px;font-size: 10px;font-weight: bold;text-decoration: none;text-transform: uppercase;color: #000;letter-spacing: 0.05em;font-family: helvetica, arial, sans-serif">
                              <a href="https://twitter.com/CSUN_Alumni" style="color: #D00D2D" target="_blank">&nbsp;&nbsp;Twitter</a>
                            </td>
                          </tr>
                        </tbody>
                      </table>
                    ...
                    <td class="social-link" style="padding: 0;vertical-align: top">
                      <table style="border-collapse: collapse;border-spacing: 0">
                        <tbody>
                          <tr>
                            <td style="padding: 0;vertical-align: top">
                              <a href="https://instagram.com/csunalumni/" target="_blank"><img height="26" src="http://www.csun.edu/ua/email/20150831_email-assets_v1/social-images/instagram.png" alt="Instagram" style="border: 0;-ms-interpolation-mode: bicubic;display: block" width="26" /></a>
                            </td>
                            <td class="social-text" style="padding: 0;vertical-align: middle !important;height: 21px;font-size: 10px;font-weight: bold;text-decoration: none;text-transform: uppercase;color: #000;letter-spacing: 0.05em;font-family: helvetica, arial, sans-serif">
                              <a href="https://instagram.com/csunalumni/" style="color: #D00D2D" target="_blank">&nbsp;&nbsp;Instagram</a>
                            </td>
                          </tr>
                        </tbody>
                      </table>
                        ...
                        <tbody>
                          <tr>
                            <td class="padded" style="padding: 0;vertical-align: top;padding-left: 10px;padding-right: 0;word-break: break-word;word-wrap: break-word;font-size: 12px;line-height: 20px;color: #000;font-family: helvetica, arial, sans-serif;text-align: right">
                              <div>
                                Copyright '.date('Y').' California State University, Northridge
                              </div>
                            </td>
                          </tr>
                        </tbody>
