<?php
/**
 * Template Name: eBlast: Invite (Extended)
 */
?>
...
<!-- VIEW ONLINE -->
                      <a href="http://www.csun.edu/ua/email/" target="_blank" style="color: #D00D2D;">Read This Email Online</a>
<!-- END VIEW ONLINE -->
                    </td>
                  </tr>
                </tbody>
          ...
          <tr>
            <td class="logo" style="padding: 0;vertical-align: top;mso-line-height-rule: at-least;padding-top: 32px;padding-bottom: 42px">
              <div class="logo-center" id="emb-email-header" style="color: #41637e; font-family: helvetica, arial, sans-serif; font-size: 26px; font-weight: 700; letter-spacing: -0.02em; line-height: 32px; text-align: center">
                <img alt="California State University, Northridge" height="74" src="http://www.csun.edu/ua/2017logos/csun.png" style="border: 0;-ms-interpolation-mode: bicubic;display: block;margin-left: auto;margin-right: auto;max-width: 454px" width="454" />
              </div>
            </td>
          </tr>
        </tbody>
                  ...
                  <tr>
                    <td class="column" style="padding: 0;vertical-align: top;text-align: left">
                      <div class="image" style="margin-bottom: 24px; color: #000; font-family: helvetica, arial, sans-serif; font-size: 12px; mso-line-height-rule: at-least; text-align: center">
                        <img alt="Alt text goes here." height="400" src="images/img1.jpg" style="border: 0;-ms-interpolation-mode: bicubic;display: block;max-width: 600px" width="600" />
                      </div>
                ...
                <tbody>
                  <tr>
                    <td class="column" style="padding: 0;vertical-align: top;text-align: center;width: 600px">
                      <div>
                        <div class="column-top" style="font-size: 36px;line-height: 36px">
                          &nbsp;
                        </div>
                      </div>
...
<!-- HEADLINE -->
                              <h1 style="margin-top: 0;color: #000;font-weight: normal;font-size: 52px;margin-bottom: 22px;font-family: Georgia,serif;text-align: center;line-height: 60px">
                                You&#8217;re Invited
                              </h1>
<!-- END HEADLINE -->
                            </td>
                          ...
                          <tr>
                            <td class="padded" style="padding: 0;vertical-align: top;padding-left: 32px;padding-right: 32px;word-break: break-word;word-wrap: break-word">
                              <table class="divider" style="border-collapse: collapse;border-spacing: 0;width: 100%">
                                <tbody>
                                  <tr>
                                    <td align="center" class="inner" style="padding: 0;vertical-align: top;padding-bottom: 32px">
                                      <table style="border-collapse: collapse;border-spacing: 0;background-color: #ffffff;font-size: 2px;line-height: 2px;width: 60px">
                                        <tbody>
                                          <tr>
                                            <td style="padding: 0;vertical-align: top">
                                              &nbsp;
                      ...
                      <table class="contents" style="border-collapse: collapse;border-spacing: 0;table-layout: fixed;width: 100%">
                        <tbody>
                          <tr>
                            <td class="padded" style="padding: 0;vertical-align: top;padding-left: 32px;padding-right: 32px;word-break: break-word;word-wrap: break-word">
<!-- COPY -->
                              <p style="margin-top: 0;color: #000;font-family: sans-serif;font-size: 21px;line-height: 29px;margin-bottom: 32px;text-align: center">
...
<!-- END COPY -->
                      ...
                      <div class="column-bottom" style="font-size: 4px;line-height: 4px">
                        &nbsp;
                      </div>
                    </td>
                  </tr>
                    ...
                    <td class="column" style="padding: 0;vertical-align: top;text-align: left">
                      ...
                      <table class="contents" style="border-collapse: collapse;border-spacing: 0;table-layout: fixed;width: 100%">
                        <tbody>
                          <tr>
                            <td class="padded" style="padding: 0;vertical-align: top;padding-left: 32px;padding-right: 32px;word-break: break-word;word-wrap: break-word">
                              <table align="center" class="image" style="border-collapse: collapse;border-spacing: 0;font-size: 0;margin-bottom: 24px;mso-line-height-rule: at-least;color: #565656;font-family: Georgia,serif">
                                <tbody>
                                  <tr>
                                    <td class="image-frame" style="padding: 8px;vertical-align: top;background-color: #D8D2C4">
                                      <span class="image-background" style="display: inline-block;font-size: 12px;background-color: #D8D2C4"><img alt="" height="347" src="images/map.jpg" style="border: 0;-ms-interpolation-mode: bicubic;display: block;max-width: 600px" width="520"></span>
                                    </td>
                                  </tr>
                                </tbody>
                              </table><!--[if mso]><br clear="all" style="mso-special-character:line-break;font-size:1px;">
      <![endif]-->
                            </td>
                          </tr>
                        </tbody>
      ...
      <table class="centered" style="border-collapse: collapse;border-spacing: 0;margin-left: auto;margin-right: auto">
        <tbody>
          <tr>
            ...
            <td style="padding: 0;vertical-align: top">
              <table class="two-col" style="border-collapse: collapse;border-spacing: 0;margin-left: auto;margin-right: auto;width: 600px;background-color: #d8d2c4;font-size: 14px;table-layout: fixed">
                <tbody>
                  <tr>
...
<!-- LOCATION -->
                            <td class="padded" style="padding: 0;vertical-align: top;padding-left: 32px;padding-right: 32px;word-break: break-word;word-wrap: break-word">
                              <h3 style="margin-top: 0;color: #000;font-weight: normal;font-size: 16px;line-height: 22px;margin-bottom: 14px;font-family: Georgia,serif;text-align: center">
                                <strong style="font-weight: bold">Location</strong>
                              </h3>
                              <p style="margin-top: 0;color: #000;font-family: sans-serif;font-size: 14px;line-height: 22px;margin-bottom: 23px;text-align: center">
                                University Hall<br/>
...
<!-- END LOCATION -->
                      ...
                      <div class="column-bottom" style="font-size: 9px;line-height: 9px">
                        &nbsp;
                      </div>
                    </td>
...
<!-- BUTTON -->
                              <div class="btn" style="margin-bottom: 24px;text-align: center">
                                <![if !mso]><a href="mailto:rsvp@example.com" style="border-radius: 3px;display: inline-block;font-size: 14px;font-weight: 700;line-height: 24px;padding: 13px 35px 12px 35px;text-align: center;text-decoration: none !important;transition: opacity 0.2s ease-in;color: #fff;font-family: sans-serif;background-color: #d00d2d">RSVP by Email</a><![endif]> <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" href="mailto:rsvp@example.com" style="width:168px" arcsize="7%" fillcolor="#D00D2D" stroke="f"><v:textbox style="mso-fit-shape-to-text:t" inset="0px,12px,0px,11px"><center style="font-size:14px;line-height:24px;color:#FFFFFF;font-family:sans-serif;font-weight:700;mso-line-height-rule:exactly;mso-text-raise:4px">RSVP by Email</center></v:textbox></v:roundrect><![endif]-->
                              </div>
<!-- END BUTTON -->
                            </td>
                          </tr>
...
<!-- PHONE or OTHER CONTACT -->
                              <p style="margin-top: 0;color: #000;font-family: sans-serif;font-size: 16px;line-height: 24px;margin-bottom: 24px;text-align: center">
                                or call (818) 677-1200
                              </p>
<!-- END PHONE or OTHER CONTACT -->
                            </td>
                          </tr>
                        </tbody>
                      </table>
                      ...
                      <table class="contents" style="border-collapse: collapse;border-spacing: 0;table-layout: fixed;width: 100%">
                        <tbody>
                          <tr>
                            <td class="padded" style="padding: 0;vertical-align: top;padding-left: 32px;padding-right: 32px;word-break: break-word;word-wrap: break-word">
<!-- SECTION HEADLINE -->
                              <h1 style="margin-top: 0;color: #000;font-weight: 700;font-size: 36px;margin-bottom: 18px;font-family: Georgia,serif;line-height: 44px">
                                Stay Connected
                              </h1>
<!-- END SECTION HEADLINE -->
                      ...
                      <div class="image" style="margin-bottom: 24px; color: #000; font-family: sans-serif; font-size: 12px; mso-line-height-rule: at-least; text-align: center">
                        <img alt="" height="13" src="images/bg_border2.png" style="border: 0;-ms-interpolation-mode: bicubic;display: block;max-width: 600px" width="600" />
                      </div>
                      <table class="contents" style="border-collapse: collapse;border-spacing: 0;table-layout: fixed;width: 100%">
                        <tbody>
                          <tr>
                            <td class="padded" style="padding: 0;vertical-align: top;padding-left: 32px;padding-right: 32px;word-break: break-word;word-wrap: break-word">
<!-- SECTION COPY -->
                              <p style="margin-top: 0;color: #000;font-family: sans-serif;font-size: 16px;line-height: 24px;margin-bottom: 24px">
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum vitae sollicitudin quam. Donec at mattis orci. Phasellus quam nulla, fringilla ut condimentum vel, aliquet vitae eros. Phasellus quam nulla, fringilla ut condimentum vel, aliquet vitae eros.
                              </p>
<!-- END SECTION COPY -->
                            </td>
                          </tr>
                      ...
                      <table class="contents" style="border-collapse: collapse;border-spacing: 0;table-layout: fixed;width: 100%">
                        <tbody>
                          <tr>
                            <td class="padded" style="padding: 0;vertical-align: top;padding-left: 32px;padding-right: 32px;word-break: break-word;word-wrap: break-word">
<!-- CONTACT COLUMN -->
                              <h2 style="margin-top: 0;color: #000;font-style: italic;font-weight: normal;font-size: 20px;line-height: 26px;margin-bottom: 18px;font-family: Georgia,serif">
                                <strong style="font-weight: bold">Contact Us</strong>
                              </h2>
                              <p style="margin-top: 0;color: #000;font-family: sans-serif;font-size: 14px;line-height: 22px;margin-bottom: 22px">
                                <strong style="font-weight: bold">Pete Medina</strong><br/>
                                (818) 677-1200<br/>
                                <a href="mailto:office.name@csun.edu" style="transition: opacity 0.2s ease-in;text-decoration: underline;color: #d00d2d">office.name@csun.edu</a>
                              </p>
                              <p style="margin-top: 0;color: #000;font-family: sans-serif;font-size: 14px;line-height: 22px;margin-bottom: 23px">
                                <strong style="font-weight: bold">CSUN University Advancement</strong><br/>
                                18111 Nordhoff Street<br/>
                                Northridge, CA 91330-8385
                              </p>
<!-- END CONTACT COLUMN -->
                            </td>
                          </tr>
...
<!-- LINKS CONTACT COLUMN -->
                              ...
                              <p style="margin-top: 0;color: #000;font-family: sans-serif;font-size: 14px;line-height: 22px;margin-bottom: 23px">
                                <a href="#" target="_blank" style="transition: opacity 0.2s ease-in;text-decoration: underline;color: #d00d2d">Department Link</a><br/>
                                <a href="#" target="_blank" style="transition: opacity 0.2s ease-in;text-decoration: underline;color: #d00d2d">Department Link</a><br/>
                                <a href="#" target="_blank" style="transition: opacity 0.2s ease-in;text-decoration: underline;color: #d00d2d">Department Link</a><br/>
                                <a href="#" target="_blank" style="transition: opacity 0.2s ease-in;text-decoration: underline;color: #d00d2d">Department Link</a><br/>
                                <a href="#" target="_blank" style="transition: opacity 0.2s ease-in;text-decoration: underline;color: #d00d2d">Department Link</a><br/>
                              </p>
<!-- END LINKS CONTACT COLUMN -->
                            </td>
                          </tr>
                        </tbody>
                      </table>
                    ...
                    <td class="social-link" style="padding: 0;vertical-align: top">
                      <table style="border-collapse: collapse;border-spacing: 0">
                        <tbody>
                          <tr>
                            <td style="padding: 0;vertical-align: top">
                              <a href="http://facebook.com/calstatenorthridge/" target="_blank"><img height="26" src="http://www.csun.edu/ua/email/20150831_email-assets_v1/social-images/facebook.png" alt="Facebook icon" style="border: 0;-ms-interpolation-mode: bicubic;display: block" width="26" /></a>
                            </td>
                            <td class="social-text" style="padding: 0;vertical-align: middle !important;height: 21px;font-size: 10px;font-weight: bold;text-decoration: none;text-transform: uppercase;color: #000;letter-spacing: 0.05em;font-family: helvetica, arial, sans-serif">
                              <a href="http://facebook.com/calstatenorthridge/" style="color: #D00D2D" target="_blank">Facebook </a>
                            </td>
                          </tr>
                        </tbody>
                      </table>
                    ...
                    <td class="social-link" style="padding: 0;vertical-align: top">
                      <table style="border-collapse: collapse;border-spacing: 0">
                        <tbody>
                          <tr>
                            <td style="padding: 0;vertical-align: top">
                              <a href="http://twitter.com/csunorthridge/" target="_blank"><img height="26" src="http://www.csun.edu/ua/email/20150831_email-assets_v1/social-images/twitter.png" alt="Twitter icon" style="border: 0;-ms-interpolation-mode: bicubic;display: block" width="26" /></a>
                            </td>
                            <td class="social-text" style="padding: 0;vertical-align: middle !important;height: 21px;font-size: 10px;font-weight: bold;text-decoration: none;text-transform: uppercase;color: #000;letter-spacing: 0.05em;font-family: helvetica, arial, sans-serif">
                              <a href="http://twitter.com/csunorthridge/" style="color: #D00D2D" target="_blank">&nbsp;&nbsp;Twitter</a>
                            </td>
                          </tr>
                        </tbody>
                      </table>
                    ...
                    <td class="social-link" style="padding: 0;vertical-align: top">
                      <table style="border-collapse: collapse;border-spacing: 0">
                        <tbody>
                          <tr>
                            <td style="padding: 0;vertical-align: top">
                              <a href="https://www.instagram.com/csun_edu/" target="_blank"><img height="26" src="http://www.csun.edu/ua/email/20150831_email-assets_v1/social-images/instagram.png" alt="Instagram" style="border: 0;-ms-interpolation-mode: bicubic;display: block" width="26" /></a>
                            </td>
                            <td class="social-text" style="padding: 0;vertical-align: middle !important;height: 21px;font-size: 10px;font-weight: bold;text-decoration: none;text-transform: uppercase;color: #000;letter-spacing: 0.05em;font-family: helvetica, arial, sans-serif">
                              <a href="https://www.instagram.com/csun_edu/" style="color: #D00D2D" target="_blank">&nbsp;&nbsp;Instagram</a>
                            </td>
                          </tr>
                        </tbody>
                      </table>
