<?php
/*
Template Name: eBlast: CSUN Weekly
*/

  // Replace paragraphs, smart quotes, and links
  // This could definitely be simplified and made less redundant
  // had to ship fast to meet a deadline, can revise later
  function es_replace($field, $section, $sub = false){
    if($section == "main"){
      $copy_find = array(
      ...
      $copy_replace = array(
        "<p style=\"margin-top: 0;color: #000;font-family: Georgia,serif;font-size: 16px;line-height: 25px;margin-bottom: 25px; text-align: left;\">",
        "<p style=\"margin-top: 0;color: #000;font-family: Georgia,serif;font-size: 16px;line-height: 25px;margin-bottom: 25px; text-align: left;\">",
        "<p style=\"margin-top: 0;color: #000;font-family: Georgia,serif;font-size: 16px;line-height: 25px;margin-bottom: 25px; text-align: left;\">",
        "<p style=\"margin-top: 0;color: #000;font-family: Georgia,serif;font-size: 16px;line-height: 25px;margin-bottom: 25px; text-align: left;\">",
        "<a style=\"color: #d00d2d;\" "
      );
      ...
      $copy_replace = array(
        "<p style=\"margin-top: 0;color: #000;font-family: Georgia,serif;font-size: 12px;line-height: 21px;margin-bottom: 21px text-align: left;\">",
        "<p style=\"margin-top: 0;color: #000;font-family: Georgia,serif;font-size: 12px;line-height: 21px;margin-bottom: 21px text-align: left;\">",
        "<p style=\"margin-top: 0;color: #000;font-family: Georgia,serif;font-size: 12px;line-height: 21px;margin-bottom: 21px text-align: left;\">",
        "<p style=\"margin-top: 0;color: #000;font-family: Georgia,serif;font-size: 12px;line-height: 21px;margin-bottom: 21px text-align: left;\">",
      );
    } elseif($section == "story_title") {
      $copy_find = array(
        "<p style=\"text-align: right;\">",
        "<p style=\"text-align: center;\">",
        "<p style=\"text-align: left;\">",
    ...
    if($sub == false){
        $the_field = get_field($field);
    } else {
        $the_field = get_sub_field($field);
    }

    $replaced = str_replace($copy_find, $copy_replace, $the_field);
    ...
    $sanitized = str_replace($html_before, $html_after, htmlentities($replaced, 0, 'UTF-8'));

    return $sanitized;
  }

    // Display the appropriate Focus On title depending on the audience.
    switch (get_field('audience')) {
        case 'Staff':
            $focus_on_heading = 'Focus on Faculty &amp; Staff';
            $the_news_heading = 'CSUN in the News';
            $archive_link = 'http://csunshinetoday.csun.edu/csun-shine-weekly-archives-for-faculty-and-staff/';
            break;
        case 'Alumni':
            $focus_on_heading = 'Focus on Alumni &amp; Community';
            $the_news_heading = 'CSUN in the News';
            $archive_link = 'http://csunshinetoday.csun.edu/csun-shine-weekly-archives/';
            break;
        case 'Students':
            $focus_on_heading = 'Focus on Students';
            $the_news_heading = 'CSUN on Social Media';
            $archive_link = 'http://csunshinetoday.csun.edu/csun-weekly-archives-students/';
            break;
    }
...
<!--
  ...
  --> 
    ...
    <!-- Pre-header -->
                    ...
                    <?php echo es_replace('issue_date', 'date'); ?><br/>

                    Volume <?php the_field('volume_number'); ?>, Edition <?php the_field('issue_number'); ?>    <!-- End Pre-header -->
    ...
    <!-- View Online -->
                    ...
                    Trouble loading? <a style="color: #d00d2d" href="<?php the_permalink(); ?>" target="_blank"><strong>View this email online.</strong></a>
    ...
    <!-- Logo -->
              ...
              <img style="border: 0;-ms-interpolation-mode: bicubic;display: block;margin-left: auto;margin-right: auto;max-width: 600px" src="http://www.csun.edu/ua/email/20171017_shine_weekly_alumni_v1/images/logo.png" alt="CSUN | California State University, Northridge" width="600" height="120" />
            ...
            - OR -
             ...
             REMOVE BOTTOM BORDER as well. -->
                    ...
                    <div class="image" style="font-size: 12px;margin-bottom: 24px;mso-line-height-rule: at-least;color: #000;font-family: Georgia,serif" align="center">
                      ...
                      <a href="<?php the_field('feature_story_link'); ?>" target="_blank">

                        <img style="border: 0;-ms-interpolation-mode: bicubic;display: block;max-width: 600px" src="<?php the_field('feature_story_image'); ?>" alt="<?php the_field('feature_image_alt-text'); ?>" width="600" height="400" />
        ...
        <!-- Text Block (Single Column) -->
          ...
          <!-- Headline -->
                            ...
                            <h1 style="margin-top: 0;color: #000000;font-weight: 700;font-size: 36px;margin-bottom: 18px;font-family: sans-serif;line-height: 42px">
                              ...
                              <a style="color: #d00d2d" href="<?php the_field('feature_story_link'); ?>" target="_blank">

                                <?php echo es_replace('feature_story_title', 'story_title'); ?>                         </a>
          ...
          <!-- Content -->
                            ...
                            <?php echo es_replace('feature_story_lede', 'main'); ?>
           ...
           NOTE: Two versions, one normal, one for IE -->
                            ...
                            <div class="btn" style="margin-bottom: 23px;padding: 2px;text-align: left">
                              ...
                              <![if !mso]>
                                ...
                                <a style="border: 1px solid #ffffff;display: inline-block;font-size: 13px;font-weight: bold;line-height: 15px;outline-style: solid;outline-width: 2px;padding: 10px 0 !important;;text-align: center;text-decoration: none !important;transition: all .2s;color: #fff !important;font-family: sans-serif;background-color: #d00d2d;outline-color: #d00d2d;text-shadow: 0 1px 0 #bb0c29; width: 100% !important;" href="<?php the_field('feature_story_link'); ?>" target="_blank">
                                ...
                                <tr>
                                  ...
                                  <td class="image-frame" style="padding: 6px;vertical-align: top;background-color: #ffffff">
                                    ...
                                    <span class="image-background" style="display: inline-block;font-size: 12px;background-color: #ffffff">
                                      ...
                                      <a href="<?php the_field('story_two_link'); ?>" target="_blank">

                                        <img style="border: 0;-ms-interpolation-mode: bicubic;display: block;max-width: 300px" src="<?php the_field('story_two_image'); ?>" alt="<?php the_field('story_two_alt-text'); ?>" width="220" height="220" />
        ...
        <!-- Text Block (Two Column) -->
          ...
          <!-- Title -->
                            ...
                            <h2 style="margin-top: 0;color: #000000;font-weight: 700;font-size: 18px;margin-bottom: 16px;font-family: sans-serif;line-height: 24px">
                              ...
                              <a style="color: #d00d2d" href="<?php the_field('story_two_link'); ?>" target="_blank">

                                <?php echo es_replace('story_two_title', 'story_title'); ?>
          ...
          <!-- Content -->
                            ...
                            <?php echo es_replace('story_two_lede', 'story'); ?>
          ...
          <!-- Continue Reading -->
                            ...
                            <p style="margin-top: 0;color: #000;font-family: sans-serif;font-size: 14px;line-height: 23px;margin-bottom: 23px">
                              ...
                              <strong style="font-weight: bold">
                                ...
                                <a style="text-decoration: none;transition: all .2s;color: #d00d2d" data-emb-href-display="www.csun.edu" href="<?php the_field('story_two_link'); ?>" target="_blank">
                                ...
                                <tr>
                                  ...
                                  <td class="image-frame" style="padding: 6px;vertical-align: top;background-color: #ffffff">
                                    ...
                                    <span class="image-background" style="display: inline-block;font-size: 12px;background-color: #ffffff">
                                      ...
                                      <a href="<?php the_field('story_three_link'); ?>" target="_blank">

                                        <img style="border: 0;-ms-interpolation-mode: bicubic;display: block;max-width: 300px" src="<?php the_field('story_three_image'); ?>" alt="<?php the_field('story_three_image_alt-text'); ?>" width="220" height="220" />
        ...
        <!-- Text Block (Two Column) -->
          ...
          <!-- Title -->
                            ...
                            <h2 style="margin-top: 0;color: #000000;font-weight: 700;font-size: 18px;margin-bottom: 16px;font-family: sans-serif;line-height: 24px">
                              ...
                              <a style="color: #d00d2d" href="<?php the_field('story_three_link'); ?>" target="_blank">

                                <?php echo es_replace('story_three_title', 'story_title'); ?>
          ...
          <!-- Content -->
                            ...
                            <?php echo es_replace('story_three_lede', 'story'); ?>
          ...
          <!-- Continue Reading -->
                            ...
                            <p style="margin-top: 0;color: #000;font-family: sans-serif;font-size: 14px;line-height: 23px;margin-bottom: 23px">
                              ...
                              <strong style="font-weight: bold">
                                ...
                                <a style="text-decoration: none;transition: all .2s;color: #d00d2d" data-emb-href-display="www.csun.edu" href="<?php the_field('story_three_link'); ?>" target="_blank">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td class="image-frame" style="padding: 0;vertical-align: top;background-color: #ffffff">
                                    ...
                                    <img style="border: 0;-ms-interpolation-mode: bicubic;display: block;max-width: 600px" src="http://www.csun.edu/ua/email/20171017_shine_weekly_alumni_v1/images/bg_border.png" alt="" width="600" height="13" />
                                ...
                                <tr>
                                  ...
                                  <td class="image-frame" style="padding: 4px;vertical-align: top;background-color: #ffffff">
                                    ...
                                    <span class="image-background" style="display: inline-block;font-size: 12px;background-color: #ffffff">
                                      ...
                                      <a href="<?php the_field('event_one_link'); ?>" target="_blank">

                                        <img style="border: 0;-ms-interpolation-mode: bicubic;display: block;max-width: 200px" src="<?php the_field('event_one_image'); ?>" alt="<?php the_field('event_one_image_alt-text'); ?>" width="144" height="144" />
          ...
          <!-- Text Block (Three Column) -->
            ...
            <!-- Title -->
                            ...
                            <h2 style="margin-top: 0;color: #000000;font-weight: 700;font-size: 12px;margin-bottom: 12px;font-family: sans-serif;line-height: 22px">
                              ...
                              <a style="color: #d00d2d" href="<?php the_field('event_one_link'); ?>" target="_blank">

                                <?php echo es_replace('event_one_title', 'story_title'); ?>                              </a>
            ...
            <!-- Copy -->
                            ...
                            <?php echo es_replace('event_one_lede', 'event'); ?>
            ...
            <!-- Continue Reading -->
                            ...
                            <p style="margin-top: 0;color: #000;font-family: sans-serif;font-size: 12px;line-height: 21px;margin-bottom: 21px">
                              ...
                              <strong style="font-weight: bold">
                                ...
                                <a style="text-decoration: none;transition: all .2s;color: #d00d2d" href="<?php the_field('event_one_link'); ?>" target="_blank">
                                ...
                                <tr>
                                  ...
                                  <td class="image-frame" style="padding: 4px;vertical-align: top;background-color: #ffffff">
                                    ...
                                    <span class="image-background" style="display: inline-block;font-size: 12px;background-color: #ffffff">
                                      ...
                                      <a href="<?php the_field('event_two_link'); ?>" target="_blank">

                                        <img style="border: 0;-ms-interpolation-mode: bicubic;display: block;max-width: 200px" src="<?php the_field('event_two_image'); ?>" alt="<?php the_field('event_two_image_alt-text'); ?>" width="144" height="144" />
          ...
          <!-- Text Block (Three Column) -->
            ...
            <!-- Title -->
                            ...
                            <h2 style="margin-top: 0;color: #000000;font-weight: 700;font-size: 12px;margin-bottom: 12px;font-family: sans-serif;line-height: 22px">
                              ...
                              <a style="color: #d00d2d" href="<?php the_field('event_two_link'); ?>" target="_blank">

                                <?php echo es_replace('event_two_title', 'story_title'); ?>                             </a>
            ...
            <!-- Copy -->
                            ...
                            <?php echo es_replace('event_two_lede', 'event'); ?>
            ...
            <!-- Continue Reading -->
                            ...
                            <p style="margin-top: 0;color: #000;font-family: sans-serif;font-size: 12px;line-height: 21px;margin-bottom: 21px">
                              ...
                              <strong style="font-weight: bold">
                                ...
                                <a style="text-decoration: none;transition: all .2s;color: #d00d2d" href="<?php the_field('event_two_link'); ?>" target="_blank">
                                ...
                                <tr>
                                  ...
                                  <td class="image-frame" style="padding: 4px;vertical-align: top;background-color: #ffffff">
                                    ...
                                    <span class="image-background" style="display: inline-block;font-size: 12px;background-color: #ffffff">
                                      ...
                                      <a href="<?php the_field('event_three_link'); ?>" target="_blank">

                                        <img style="border: 0;-ms-interpolation-mode: bicubic;display: block;max-width: 200px" src="<?php the_field('event_three_image'); ?>" alt="<?php the_field('event_three_image_alt-text'); ?>" width="144" height="144" />
          ...
          <!-- Text Block (Three Column) -->
            ...
            <!-- Title -->
                            ...
                            <h2 style="margin-top: 0;color: #000000;font-weight: 700;font-size: 12px;margin-bottom: 12px;font-family: sans-serif;line-height: 22px">
                              ...
                              <a style="color: #d00d2d" href="<?php the_field('event_three_link'); ?>" target="_blank">

                                <?php echo es_replace('event_three_title', 'story_title'); ?></a>
            ...
            <!-- Copy -->
                            ...
                            <?php echo es_replace('event_three_lede', 'event'); ?>
            ...
            <!-- Continue Reading -->
                            ...
                            <p style="margin-top: 0;color: #000;font-family: sans-serif;font-size: 12px;line-height: 21px;margin-bottom: 21px">
                              ...
                              <strong style="font-weight: bold">
                                ...
                                <a style="text-decoration: none;transition: all .2s;color: #d00d2d" href="<?php the_field('event_three_link'); ?>" target="_blank">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="column article" style="padding: 0;vertical-align: top;text-align: left">
                    ...
                    if( have_rows('focus_on') ):

                      // loop through the rows of data
                        while ( have_rows('focus_on') ) : the_row(); ?>
            ...
            <!-- Text Block (Single Column) -->
              <!-- Linked Headline -->
                                  <h2 style="margin-top: 0;color: #000000;font-weight: 700;font-size: 18px;margin-bottom: 0;font-family: sans-serif;line-height: 24px">
                                    <a style="color: #d00d2d" href="<?php the_sub_field('focus-on_title_link'); ?>" target="_blank">
                                      <strong style="font-weight: bold">
                                        <?php echo es_replace('focus-on_title', 'story_title', true); ?>
                                      </strong>
                                    </a>
                                  </h2>
              <!-- End Linked Headline -->
              <!-- Content -->
                                  <?php echo es_replace('focus-on_title_lede', 'main', true); ?>
                                  <p style="margin-top: 0;color: #000;font-family: sans-serif;font-size: 14px;line-height: 23px;margin-bottom: 23px">
                                      <a style="text-decoration: none;transition: all .2s;color: #d00d2d" href="<?php the_sub_field('focus-on_title_link'); ?>" target="_blank">
                                          <strong style="font-weight: bold">
                                            Read More +
                                          </strong>
                                      </a>
        ...
        <!-- Text Block (Single Column) -->
          ...
          <!-- Linked Headline -->
                              ...
                              <h2 style="margin-top: 0;color: #000000;font-weight: 700;font-size: 18px;margin-bottom: 0;font-family: sans-serif;line-height: 24px">
                                ...
                                <a style="color: #d00d2d" href="<?php the_sub_field('news_link'); ?>" target="_blank">

                                  <strong style="font-weight: bold">

                                    <?php echo es_replace('news_title', 'story_title', true); ?>                                 </strong>
          ...
          <!-- Content -->
                              ...
                              <?php echo es_replace('news_publication', 'main', true); ?> 
                          ...
                          <tr>
                            ...
                            <td style="padding: 0;vertical-align: top">
                              ...
                              <div style="text-decoration:none;" likeurl="http://www.facebook.com/calstatenorthridge">
                                ...
                                <img style="border: 0;-ms-interpolation-mode: bicubic;display: block" src="http://www.csun.edu/ua/email/20171017_shine_weekly_alumni_v1/images/facebook.png" width="32" height="32" />
                          ...
                          <tr>
                            ...
                            <td style="padding: 0;vertical-align: top">
                              ...
                              <tweet style="text-decoration:none;">
                                ...
                                <img style="border: 0;-ms-interpolation-mode: bicubic;display: block" src="http://www.csun.edu/ua/email/20171017_shine_weekly_alumni_v1/images/twitter.png" width="32" height="32" />
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="social-text" style="padding: 0;vertical-align: middle !important;height: 21px;font-size: 10px;font-weight: bold;text-decoration: none;text-transform: uppercase;color: #000;letter-spacing: 0.05em;font-family: Georgia,serif">
                              ...
                              <a style="text-decoration:none; color: #d00d2d;" href="<?php echo $archive_link; ?>" target="_blank">
